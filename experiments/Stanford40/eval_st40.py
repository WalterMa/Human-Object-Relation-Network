...
def get_dataset(dataset, args):
    if dataset.lower() == 'st40':
        val_dataset = gdata.Stanford40Action(split='test', load_box=True, preload_label=args.eval_all)
        val_metric = VOCClsMApMetric(class_names=val_dataset.classes, ignore_label=-1)
    else:
